...
/**
 * Panel pro nastavení meta vlastností objektù - seøazení a viditelnost.
 * @author Tomáš Režnar
 */
public class ObjectOrderPanel extends JPanel
{
	...
	/**
	 * Tlaèítko pro pøesun dolù.
	 */
	private final JButton moveDownButton;
	/**
	 * Tlaèítko pro pøesun nahoru.
	 */
	private final JButton moveUpButton;
	/**
	 * Tlaèítko pro smazání.
	 */
	private final JButton deleteButton;
	/**
	 * Tlaèítko pro nastavení jestli se objekt vykreslí.
	 */
	private final JToggleButton visibleButton;
	/**
	 * Tlaèítko pro aktivaci vykreslení jediného objektu.
	 */
	private final JToggleButton exlusiveVisibleButton;
	/**
	 * Posluchaèi událostí panelu.
	 */
	...
	public ObjectOrderPanel()
	{
		...
		moveDownButton.setToolTipText("Pøesunout objekt dolù.");
		...
		visibleButton.setToolTipText("Pøepnout viditelnost objektu.");
		...
		axesPanel.add(new JLabel("Støed"), BorderLayout.WEST);
		...
		movePanel.setBorder(BorderFactory.createTitledBorder("Pøesun vybraného objektu"));
		...
		//posluchaèi tlaèítek pro pøesun
	...
	/**
	 * Povolení tlaèítka pro pøesun nahoru.
	 */
	...
	/**
	 * Povolení tlaèítka pro pøesun dolù.
	 */
	...
	/**
	 * Zjistí jestli je aktivováno tlaèítko pro nastavení zobrazení.
	 */
	...
	/**
	 * Pøepne aktivování tlaèítka pro volbu zobrazení.
	 */
	...
	/**
	 * Zjistí jestli je aktivováno tlaèítko pro nastavení exluzivního zobrazení.
	 */
	...
	/**
	 * Pøidání posluchaèe událostí panelu.
	 */
	...
	/**
	 * Odebrání posluchaèe událostí panelu.
	 */

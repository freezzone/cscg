...
/**
 * Implementace Fergusonovy køivky.
 * @author Tomáš Režnar
 */
public final class ObjectFerguson extends AbstractObjectCurve<Point3f>
{
	...
	{
		super();
		setName("Fergusonova køivka "+selfCounter++);
	...
	private void initGUI()
	{
		...
		setSteps(steps);//nastavim pøesnost
	}
	...
	public synchronized void drawNodes(GL2 gl, Projection projection)
	{
		drawSimpleNodes(gl);
		//vykreslení šipek
		int vectorsCount=points.size()-(points.size()%2);//2 body pro teènu

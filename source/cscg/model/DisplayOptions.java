...
/**
 * Tøída ukládající nastavení parametrù pro vykreslování OpenGL.
 * @author Tomáš Režnar
 */
public class DisplayOptions implements Serializable, Cloneable
{
	...
	/**
	 * Antialiasing bodù.
	 * Mùže mít hodnoty 0, GL2.GL_FASTEST, GL2.GL_NICEST
	 */
	...
	/**
	 * Ambientní složka svìtla.
	 */
	private float ambientLight = 0.2f;
	/**
	 * Difùzní složka svìtla.
	 */
	private float difuseLight = 0.5f;
	/**
	 * Odlesková složka svìtla.
	 */
	private float specularLight = 0.5f;
	/**
	 * Parametr odleskù objektù.
	 * Musí být v rozmezí 0 až 128, èím vyší èíslo, tím odlesk pokryje menší plochu.
	 */
	 ...
	 * Parametr odleskù objektù.
	 * Musí být v rozmezí 0 až 128, èím vyší èíslo, tím odlesk pokryje menší plochu.
	 * @throws IllegalArgumentException Pokud není zadáno èíslo v rozmezí 0 až 128.
	 */
	...
	/**
	 * Vytvoøení kopie objektu, posluchaèi nebudou v kopii obsaženi.
	 */
	@Override
	public Object clone()
	{
	...
	/**
	 * Nastavení vlastností dle jiné instance objektu. Posluchaèi nebudou kopírovaní.
	 * @param setBy Objekt z nìhož dojde ke kopírování vlastností.
	 */
	...
	/**
	 * Vyvolání události zmìny objektu.
	 */

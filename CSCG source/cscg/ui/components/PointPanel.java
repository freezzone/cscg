...
/**
 * Panel pro úpravu vlastností bodů - {@link IPoint3f} a tříd zděděných.
 * @author Tomáš Režnar
 */
public class PointPanel extends JPanel {
	...
	/**
	 * Posluchači změn v nastavení bodu.
	 */
	...
	public PointPanel()
	{
		...
		NumberFormat formatCoords = NumberFormat.getNumberInstance();//formát čísel
		...
		//nastavení posluchačů změn vlastností bodu
	...
	/**
	 * Odebrání posluchače změny bodu.
	 */

...
public class CameraMenu extends JPopupMenu
{
	...
	/**
	 * Přepínač způsobu zobrazení.
	 */
	private final JCheckBoxMenuItem perspective;
	/**
	 * Nastaví kameru na pohled ze předu.
	 */
	...
	/**
	 * Před zobrazením menu je nutné nastavit projekci metodou 
	...
	public void show(Component invoker, int x, int y)
	{
		if(perspective==null)
		{
			throw new NullPointerException("Před zobrazením menu je nutné nastavit projekci metodou "

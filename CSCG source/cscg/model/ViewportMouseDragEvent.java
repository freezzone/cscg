...
public class ViewportMouseDragEvent extends ViewportMouseEvent
{
	...
	/**
	 * Poloha odkud byla myš přesunuta.
	 */
	protected MouseScreenPosition fromCursorPosition;

	/**
	 * @param evt událost myši (z událasti se zjistí kam byla myš přesunuta).
	 * @param fromCursorPosition souřadnice odkud byla myš přesunuta.
	 */
